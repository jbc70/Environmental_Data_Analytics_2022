...
> Answer: matrices are written out, lists and dataframes need to be expanded
...
```{r}
highs_F <- c(58,41,43,45,35,42,49,52,56,66)
lows_F <- c(31,20,25,28,19,23,25,29,43,49)
```
...
```{r}
durham_temps <- cbind(highs_F, lows_F, highs_C, lows_C)
```
