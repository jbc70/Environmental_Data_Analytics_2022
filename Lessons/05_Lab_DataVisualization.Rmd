...
ggplot(subset(PeterPaul.chem.nutrients, depth == 0))  +
  ...
  labs(y = expression("Temperature *C"), x = "DOY", color = "Year")
#can use filter instead of subset  
...
ggplot(PeterPaul.chem.nutrients,
  ...
  labs(y = expression("Temperature (*C)"), x = "Sample Date", color = "Depth")
...
ggplot(EPAair, aes(y = Ozone, x = PM2.5, color = meanLat)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = lm)+
  labs(y = "Ozone", x = "PM2.5", color = "Latitude")
